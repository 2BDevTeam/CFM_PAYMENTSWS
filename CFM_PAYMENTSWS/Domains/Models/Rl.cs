...
namespace CFM_PAYMENTSWS.Domains.Models
{
    public partial class Rl
    {
        ...
        public decimal URlcam { get; set; }
        public decimal URltot { get; set; }
        ...
        public string UOlcodigo { get; set; } = null!;
        public string UOlgrupo { get; set; } = null!;
        public string UOlsgrupo { get; set; } = null!;
        ...
        public decimal Etotsemivacativado { get; set; }
        public decimal Totsemivacativado { get; set; }
        public decimal Mtotsemivacativado { get; set; }
    }
}
